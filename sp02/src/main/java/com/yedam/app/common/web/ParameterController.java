...
public class ParameterController {
	...
	@ResponseBody // AJAX : node 아작스 방식에서 순수하게 데이터를 넘겨받을 때
	...
	// QueryString, 2) @RequestParam (기본값)
	...
	@PostMapping("resbody")
	@ResponseBody
	public EmpVO resuquestBody(@RequestBody EmpVO empVO) {
		return empVO;
	}
